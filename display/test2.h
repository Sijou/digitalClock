...
#ifndef DISPLAY_MARILYN_MONROE_H_
#define DISPLAY_MARILYN_MONROE_H_


// Bitmap of Marilyn_Monroe Image
const unsigned char marilyn_monroe [] = {
...
#endif// DISPLAY_MARILYN_MONROE_H_
